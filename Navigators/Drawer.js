  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: () => <HomeIcon name="home" size={20} color="black" />,
        }}
      />
      ...
      <Drawer.Screen
        ...
        component={MyProfile}
        options={{
          drawerIcon: () => <HomeIcon name="user" size={20} color="black" />,
        }}
      />
      ...
      <Drawer.Screen
        ...
        component={Settings}
        options={{
          drawerIcon: () => <HomeIcon name="setting" size={20} color="black" />,
        }}
      />
    </Drawer.Navigator>
  );
